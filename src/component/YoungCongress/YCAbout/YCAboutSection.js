        ...
        <div className='ycasection-container'>
            ...
            <div className="yca-about-section">
                <div className="yca-about-text">
                    <h3>About Us</h3>
                    <p>Young Congress NRB Global is a non-political Organization. This platform is open for all young generation. We give the opportunities to be a good person in life as well as to improve skills for career build up.</p>
                </div>
                <div className="yca-presenet-them">
                    <div className="yca-research">
                        <h1>01. 6 years of intense  research</h1>
                    ...
                    <div className="yca-audience">
                        <h1>02. 6 years of intense  research</h1>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ut reprehenderit repellendus consequatur asperiores voluptate corrupti?</p>
                    </div>
                    <div className="yca-contact">
                        <h1>03. 6 years of intense  research</h1>
                        <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ut reprehenderit repellendus consequatur asperiores voluptate corrupti?</p>
                    </div>
                </div>
            </div>
