...
import intoImg from "../../../assets/image/about/about-nrb.jpg";
import "./Intro.css";
          ...
          <div className="grid">
            ...
            <div className="sm:col-12 md:col-12 lg:col-6 xl:col-6  ">
              ...
              <p className="intro-details  lg:ml-5 xl:ml-5 mt-4">
                ...
                non-political organization of Bangladeshis living abroad. This
                is the first organization to a unit about 15 Million
                Bangladeshis all over the world.NRB Global is the bridge between
                Bangladesh and Bangladeshis living abroad. <br /> <br /> NRB
                Global believes that the experience of Bangladeshis living
                abroad can be a great asset to the development of
                Bangladesh.oreign currency remitted by the Bangladeshis
                constitutes a large part of the national economy: amounting to
                as high as 14% of GDP in some year. <br /> <br />
                Besides sending hefty remittances, each NRB is a 'Brand
                Ambassador' aboard for our homeland.From NASA to Massachusetts
                (MIT), Restaurant business in London, small business in New
                York, real estate business in the Middle East, active
                parliamentarians in the US and UK.
                <br /> <br />
